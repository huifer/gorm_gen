package com.github.huifer.plugin.model.db;
...
public class Matcher {
  ...
  public static List<String> match(String regString, int index, String content) {
    ...
    java.util.regex.Matcher mr = Pattern
        .compile(regString, Pattern.DOTALL + Pattern.CASE_INSENSITIVE).matcher(content);
    while (mr.find()) {
  ...
  public static List<String> match(String regString, String content) {
    List<String> r = new ArrayList<String>();
    java.util.regex.Matcher mr = Pattern
        .compile(regString, Pattern.CASE_INSENSITIVE + Pattern.DOTALL).matcher(content);
    outer:
    while (mr.find()) {
      inner:
